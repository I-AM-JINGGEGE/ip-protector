...
import com.ironmeta.one.constants.RemoteConstants.ADD_TIME_MAX_DURATION_VALUE_DEFAULT
...
import com.ironmeta.one.report.ReportConstants.AppReport.SOURCE_ADD_TIME_REPORT_PAGE_1
import com.ironmeta.one.report.ReportConstants.AppReport.SOURCE_ADD_TIME_REPORT_PAGE_2
            ...
            override fun onItemSelected(type: RatingBar.Type) {
                ...
                when(type) {
                    ...
                    RatingBar.Type.GREAT, RatingBar.Type.GOOD -> {
                        if (AppStoreUtils.openPlayStoreOnlyWithUrl(this@ConnectedReportActivity, SupportUtils.GP_LINK)) {
